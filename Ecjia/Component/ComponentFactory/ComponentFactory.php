...
abstract class ComponentFactory
{
     ...
     * @return  string
     */
    abstract public function getHookTag();
    
    public function getFactories()
    {
        $factories = $this->getCacheInstance()->get($this->getCacheKey());
        if (empty($factories)) {
            ...
            $this->getCacheInstance()->put($this->getCacheKey(), $factories, 10080);
        }
    
        return RC_Hook::apply_filters($this->getHookTag(), $factories);
    }
