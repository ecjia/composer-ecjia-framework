...
namespace Ecjia\Component\AppClient\Config;
...
abstract class ApplicationConfig
{
    ...
    /**
     * @var \Ecjia\Component\AppClien\Platform\ApplicationPlatformFactory
     */
    protected static $factory;

    /**
     * @return \Ecjia\Component\AppClien\Platform\ApplicationPlatformFactory
     */
    public static function getApplicationFactory()
    {
        if (is_null(self::$factory)) {
            self::$factory = new ApplicationPlatformFactory();
        }
